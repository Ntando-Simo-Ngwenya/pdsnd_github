...
def city_input():
    '''
    This function starts the user interface with an introduction and
    asks the user which city he/she wants to analyze
    '''
    print('Hello! I am Ntando Ngwenya, your guide through this vast database! Let\'s explore some US bikeshare data!')
    print(' ')
    # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    print('Enter the city you want to analyze the data for as prompted below:')
    print('Chicago: 1')
    print('New York: 2')
    print('Washington: 3')
    print(' ')
    ...
    while True:     # for handling the unexpected input by user
            if city == '1' or city == 'chicago':
                print("\nChicago City selcted! Let's go further\n")
                return 'chicago'
            if city == '2' or city == 'new york':
                print("\nNew York City selcted! Let's go further\n")
                return 'new york city'
            elif city == '3' or city == 'washington':
                print("\nWashington selected! Let's go further\n")
                return 'washington'
...
def get_time():
    ...
    '''
    period = input('\n Would you like to filter the data by month and day of the month, day of the week, or not filter the data at all? Type "no" for no period filter.\n')
    period = period.lower()

    while True: 
        if period == "month":
            while True:
                day_month = input("\n Would you like to filter the data by day of the month as well? Type 'YES' or 'NO'\n").lower()
                if day_month == "no":
        ...
        if period == "day":
            ...
            return "none"
        period = input("\n Please choose how the data should be filtered between 'month', 'day' of the week, or none (no) \n").lower()
...
def month_freq(df):
    ...
    print('\n * Q1. Which is the most popular month for bike traveling?')
    m = df.month.mode()[0]
    months = ['january', 'february', 'march', 'april', 'may', 'june']
...
def day_freq(df):
    '''Which is the most popular day of week for start time?
    '''
    # df - dataframe returned from time_filters
    print('\n * Q2. Which is the most popular day of the week for bike rides?')
...
def hour_freq(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print('\n * Q3. Which is the most popular hour of the day for bike rides?')
...
def ride_duration(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print('\n * Q4. What was the total traveling time through June 2017, and what was the average time spent on each trip?')
    ...
    print ("\nThe total travel time in 2017 through June was " + total_days + " days \n")
    avg_ride_time = np.mean(df['Travel Time'])
    avg_days = str(avg_ride_time).split()[0]
    print("The average travel time in 2017 through June was " + avg_days + " days \n")

    return total_ride_time, avg_ride_time

def stations_freq(df):
    '''Which is the most popular start station and most popular end station?
    '''
    # df - dataframe returned from time_filters
    print("\n* Q5. Which is the most popular start station?\n")
    start_station = df['Start Station'].value_counts().reset_index()['index'][0]
    print (start_station)
    print("\n* Q6. Which end station is the most popular?\n")
...
def common_trip(df):
    ...
    print('\n* Q7. Which route was the most popular from start to end?')
    return result
...
def bike_users(df):
    ...
    '''
     # df - dataframe returned from time_filters
    print('\n* Q8. Types of users: subscribers, customers, or others?\n')
...
def gender_data(df):
    ...
    # df - dataframe returned from time_filters
    try:
        print('\n* Q9. What is the gender breakdown amongst users?\n')
...
def birth_years(df):
    ...
    # df - dataframe returned from time_filters
    try:
        print('\n* Q10. What are the earliest, latest, and most frequent years of birth, respectively?')
